    ...
    return (
      <section className="contact-form know-more">
        <div className="content center">
          ...
          <p className="sub2">
            If you share with us your email address, we'll send you a detailed
            presentation on us:
            <br /> who we are, how we work, what kind of projects we recently
            delivered, etc.
          </p>
          ...
          <div className="narrow-column">
            <p className=" micro">
              Clicking "I want to know more" you consent to processing your data
              by Brains&nbsp;&amp;&nbsp;Beards&nbsp;sp.&nbsp;zo.o. for marketing
              purposes, including sending emails.
            </p>
          </div>
        </div>
      </section>
