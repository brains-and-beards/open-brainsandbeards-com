...
const SubscribeFootnote = () => (
  <>
    ...
    <p>
      ...
      <a href="https://podcast.brainsandbeards.com">our podcast</a>! We're still figuring out what
      it's going to be, but already quite a few episodes are waiting for you to check them out.
    </p>
  </>
)

export default SubscribeFootnote
