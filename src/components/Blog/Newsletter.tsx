    ...
    <section className="estimateProject">
      <div className="content row">
        ...
        <div className="center newsletter-content">
          ...
          <p className="sub2">
            Stay in touch with us! If you subscribe, we will keep you up to date
            with our new adventures, learnings and insights.
          </p>

          <p className="sub2">
            {" "}
            If emails are not your cup of coffee, you can use{" "}
            <a href="https://brainsandbeards.com/blog/feed.xml">
              RSS feed
            </a>{" "}
            instead.
          </p>
      ...
      <div className="blog-micro">
        <p className=" micro">
          ...
          Brains & Beards sp. z o.o. for marketing purposes, including sending
          emails.
        </p>
      </div>
