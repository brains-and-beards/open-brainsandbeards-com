...
![A collection of different button states and animations in a mobile app](./header.jpg "Different states of our NiceButton component: default, pressed, disabled, and loading")
...
![Basic button implementation with default styling](./header.jpg "Basic button with default styling and no animations")
...
![Button press animation showing scale and opacity changes](./header.jpg "Button being pressed with scale and opacity animations")
...
![Button in different states: default, disabled, and loading](./header.jpg "Button showing different states with smooth color transitions")
...
![Loading animation with rotating icon](./header.jpg "Button in loading state with spinning icon animation")
...
![Final button implementation with all features](./header.jpg "Complete button implementation with all states and animations")

You can try it out in this [Expo Snack](https://snack.expo.dev/@sakydpozrux/nice-button).
...
![Example usage of NiceButton in different configurations](./header.jpg "Example showing different button configurations: basic, with save icon, and full width")
